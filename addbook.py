...
class AddBook(Toplevel):
    def __init__(self):
        ...
        #heading, image
        self.top_image = PhotoImage(file='icons/add128.png')
        top_image_lbl = Label(self.topFrame,image=self.top_image,bg='white')
        top_image_lbl.place(x=120,y=10)
        heading = Label(self.topFrame,text='   Add Book ',font='Calibri 22 bold',fg='#003f8a',bg='white')
        ...
        #author
        self.lbl_author = Label(self.bottomFrame,text='Author: ',font='Calibri 15 bold',fg='white',bg='#fcc324')
        ...
        #page
        self.lbl_page = Label(self.bottomFrame,text='Page: ',font='Calibri 15 bold',fg='white',bg='#fcc324')
        self.lbl_page.place(x=40,y=120)
        self.ent_page = Entry(self.bottomFrame,width=30,bd=2)
        self.ent_page.insert(0,"Please enter page volume")
        self.ent_page.place(x=150,y=120)
        #language
        self.lbl_language = Label(self.bottomFrame,text='Language: ',font='Calibri 15 bold',fg='white',bg='#fcc324')
